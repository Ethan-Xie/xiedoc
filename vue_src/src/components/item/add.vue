    ...
    <el-container>
          <el-card class="center-card">
            <el-form  status-icon  label-width="0px" class="demo-ruleForm">
              ...
              <el-form-item>
                <el-input type="text" suto-complete="off" :placeholder="$t('item_name')" v-model="item_name"></el-input>
              </el-form-item>
              <el-form-item label="" >
              ...
              <el-form-item label="" >
                <el-input type="text" auto-complete="off"  placeholder="(可选)个性域名" v-model="item_domain" ></el-input>
              </el-form-item>
              ...
              <el-form-item class="text-left">
                ...
                <el-select v-model="copy_item_id" :placeholder="$t('please_choose')" v-if="show_copy" @change="choose_copy_item">
                  <el-option v-for="item in itemList" :key="item.item_id" :label="item.item_name" :value="item.item_id"></el-option>
                </el-select>
              </el-form-item>
...
export default {
  ...
  methods: {
    ...
    choose_copy_item (itemId) {
      for (var i = 0; i < this.itemList.length; i++) {
        if (itemId === this.itemList[i].item_id) {
    ...
    onSubmit () {
      var that = this
      var url = this.DocConfig.server + '/api/item/add'
    ...
    auto_doc () {
      var msg = '<p>如果你想自动化生成API文档，则可参考<a target="_bank" href="#">API文档</a></p>'
      msg += '<p>如果你想自动化生成数据字典，则可参考<a target="_bank" href="#">数据字典</a></p>'
      msg += '<p>如果你更自由地生成自己所需要的格式，则可参考<a target="_bank" href="#">开放API</a></p>'
      this.$alert(msg, {
